        ...
        if i in thisway:
            ...
            if((m%2==0 and n%2==0) or (m%2==1 and n%2==1)):
                if current in numbers:
                    print(newperiod+1," : ðŸ’¥ðŸ”´RED1ðŸ”´ðŸ’¥")
                else:
                    print(newperiod+1," : ðŸ’¥ðŸŸ¢GREEN1ðŸŸ¢ðŸ’¥")
            else:
                if current in numbers:
                    print(newperiod+1," :  ðŸ’¥ðŸ”´RED2ðŸ”´ðŸ’¥")
                else:
                    print(newperiod+1," : ðŸ’¥ðŸ”´RED3ðŸ”´ðŸ’¥")
        if i in thatway:
            m=getSum(current)+1
            n=int(current)%10
            if((m%2==0 and n%2==0) or (m%2==1 and n%2==1)):
                if current in numbers:
                    print(newperiod+1,": ðŸ’¥ðŸ’¥ðŸŸ¢GREEN2ðŸŸ¢ðŸ’¥ðŸ’¥")
                else:
                    print(newperiod+1,": ðŸ’¥ðŸ’¥ðŸŸ¢GREEN3ðŸŸ¢ðŸ’¥ðŸ’¥")
            else:
                if current in numbers:
                    print(newperiod+1,": ðŸ’¥ðŸ’¥ðŸ”´RED4ðŸ”´ðŸ’¥ðŸ’¥")
                else:
                    print(newperiod+1,": ðŸ’¥ðŸ’¥ðŸŸ¢GREEN4ðŸŸ¢ðŸ’¥ðŸ’¥")
        i=i+1
        newperiod+=1
...
if(expirydate>today):
    ...
    if (now>First and now<Firstend):
        ...
        print("14th Mar 2022, 10:00 PM- 10:35 PM")
        print("14th Mar 2022, 12:00 PM- 12:35 PM")
        print("14th Mar 2022, 03:00 PM- 03:35 PM")
        print("14th Mar 2022, 08:00 PM- 08:35 PM")
        print("14th Mar 2022, 11:00 PM- 12:35 PM")
